...
var Names =['Computer Science', 'Medicine', 'Biology', 'Physics', 'Psychology', 'Mathematics'];// ["Black Widow","Captain America","Hawkeye","the Hulk","Iron Man","Thor"],
	colors =["#fd7f6f", "#7eb0d5", "#b2e061", "#bd7ebe", "#ffb55a", "#ffee65", "#beb9db", "#fdcce5", "#8bd3c7", "#a6d75b"];// ["#301E1E", "#083E77", "#342350", "#567235", "#8B161C", "#DF7C00"],
	opacityDefault = 0.8;
	...
	$(this).popover({
		...
		content: function() { 
			return "<p style='font-size: 11px; text-align: center;'><span style='font-weight:900'>" + Names[d.source.index] + 
				   ...
				   "</span> appeared together in <span style='font-weight:900'>" + d.source.value + "</span> papers </p>"; }
	});
	$(this).popover('show');
}//mouseoverChord
